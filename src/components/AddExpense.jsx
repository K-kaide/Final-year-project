...
/* _____________________________________________________ */
    ...
    const bull = (
      ...
      const Expense = ({showExpense, setShowExpense}) => {
    
        
    const [value, setValue] = React.useState(new Date());

    function turn(){
      document.getElementsByClassName("rotation")[0].classList.toggle("rotation-90");
      document.getElementsByTagName("dd")[0].classList.toggle("full");
    }
      ...
      >        
        {/*  <div className="addexpense-input">
          <Input placeholder="Placeholder"/> 
            ...
            <div class="main-app-left-side">
                <dl>
                    <dt onClick={turn}>
                        <div class="tag-icon">
                            <span>  
                                <img src={TAG} alt="food" />                          
                                <h4>Tags</h4>
                            </span>
                            <img class="rotation" src={ARR} alt=""/> 
                        </div>
                    </dt>
                    {/* 
                    <dd>
